...
of data for the kinds data mentioned above."), br(),
h5("GITHUB REPO:"),
...
# shows the model for the global data
   ...
   and a steady increase in urban population"),
                                ...
                                tabPanel(title = "Model",
                                  ...
                                  h6("The values above indicate that our model is not a perfect fit for our data. 
                                     Because we are witnessing a strong negative correlation between forested area and urban population; 
                                     therefore we are expecting a negative")))),
...
# country.
                            ...
                            tabPanel(title = "DATA PER COUNTRY", 
                                   ...
                                   tabPanel(title = "Model",
                                        ...
                                        h6("of increase in urban population for each country,"),
                                        h6("take median value and add it urban_pop value"),
                                        br(),
                                           tableOutput("table_2")))),
...
Urban population and forested area seem to exhibit a strong negative correlation. With urban population plotted on the x-axis and forested on the y-axis, 
their relationship can be modelled by Y = (-2.3e+11) + 6241X. It is also worth mentioning that these equations have imitations. 
...
It would be better, therefore, to look at the countries individually when creating this kind of model." ),
br(),
...
server <- function(input, output, session) {
    ...
    output$plot_3 <- renderPlot ({
      ggplot(data = World_pop_forest, 
        ...
        scale_y_continuous(labels = scales::comma) +
        geom_text(aes(x = 3500000000, y = 4150000, label = lm_eqn(World_pop_forest)), parse = TRUE)
        }, height = 400, width = 700 )
